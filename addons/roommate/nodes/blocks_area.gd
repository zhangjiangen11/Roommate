...
func _create_default_part(anchor: Vector3, flow: Vector3, part_transform: Transform3D, 
		set_mesh := true, set_nav := false, set_occluder := false) -> RoommatePart:
